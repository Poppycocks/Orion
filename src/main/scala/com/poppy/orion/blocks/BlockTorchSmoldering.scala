...
class BlockTorchSmoldering extends BlockTorch {

  val name: String = "torchsmoldering"
  ...
  override def onBlockAdded(world: World, x: Int, y:Int, z:Int): Unit ={
    if (Config.torchBurnTime!=0)world.scheduleBlockUpdate(x, y, z, this, (Config.torchBurnTime * 0.1).toInt)
  }

  override def updateTick(world: World, x: Int, y: Int, z:Int, rand: Random): Unit ={
    val meta = world.getBlockMetadata(x,y,z)
    world.setBlock(x,y,z,Blocks.blockTorchUnlit, meta, 2)
